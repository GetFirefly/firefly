...
fn with_local_reference_errors_badarg() {
    ...
    assert_bad_argument!(erlang::atom_to_list_1(atom, &mut process), &mut process);
}
...
fn with_empty_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(Term::EMPTY_LIST, &mut process),
        &mut process
    );
}
...
fn with_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(list_term, &mut process),
        &mut process
    );
}
...
fn with_small_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(small_integer_term, &mut process),
        &mut process
    );
}
...
fn with_big_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(big_integer_term, &mut process),
        &mut process
    );
}
...
fn with_float_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(float_term, &mut process),
        &mut process
    );
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(local_pid_term, &mut process),
        &mut process
    );
}
...
fn with_external_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(external_pid_term, &mut process),
        &mut process
    );
}
...
fn with_tuple_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(tuple_term, &mut process),
        &mut process
    );
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::atom_to_list_1(map_term, &mut process), &mut process);
}
...
fn with_heap_binary_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(heap_binary_term, &mut process),
        &mut process
    );
}
...
fn with_subbinary_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::atom_to_list_1(subbinary_term, &mut process),
        &mut process
    );
}
