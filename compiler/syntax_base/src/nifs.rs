...
lazy_static! {
    static ref NIF_SIGNATURES: Vec<Signature> = {
        vec![
            // pub __lumen_make_tuple(isize) -> tuple
            ...
            // pub __lumen_tuple_size(term) -> i1, u32
            ...
            // pub __lumen_map_put(map, term, term) -> map
            ...
            // pub __lumen_map_put_mut(map, term, term) -> map
            ...
            // pub __lumen_map_update(map, term, term) -> i1, map
            ...
            // pub __lumen_map_update_mut(map, term, term) -> i1, map
            ...
            // pub __lumen_map_fetch(map, term) -> i1, term
            ...
            // pub __lumen_build_stacktrace(exception_trace) -> term
            ...
            // pub __lumen_bs_finish(binary_builder) -> i1, term
