...
fn with_atom_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size(atom_term, &mut process), &mut process);
}
...
fn with_list_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size(list_term, &mut process), &mut process);
}
...
fn with_float_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size(float_term, &mut process), &mut process);
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size(local_pid_term, &mut process), &mut process);
}
...
fn with_tuple_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size(tuple_term, &mut process), &mut process);
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size(map_term, &mut process), &mut process);
}
