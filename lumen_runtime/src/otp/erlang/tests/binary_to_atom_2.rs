...
fn with_atom_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(atom_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_local_reference_errors_badarg() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(binary, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_empty_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(Term::EMPTY_LIST, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(list_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_small_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(small_integer_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_big_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(big_integer_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_float_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(float_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(local_pid_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_external_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(external_pid_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_tuple_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(tuple_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(map_term, encoding_term, &mut process),
        &mut process
    );
}
...
fn with_heap_binary_without_encoding_atom_returns_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(heap_binary_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_heap_binary_with_invalid_encoding_atom_returns_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(heap_binary_term, invalid_encoding_term, &mut process),
        &mut process
    );
}
...
fn with_heap_binary_with_valid_encoding_returns_atom() {
    ...
    assert_eq_in_process!(
        erlang::binary_to_atom_2(heap_binary_term, latin1_atom_term, &mut process),
        Ok(atom_term),
        process
    );
    assert_eq_in_process!(
        erlang::binary_to_atom_2(heap_binary_term, unicode_atom_term, &mut process),
        Ok(atom_term),
        process
    );
    assert_eq_in_process!(
        erlang::binary_to_atom_2(heap_binary_term, utf8_atom_term, &mut process),
        Ok(atom_term),
        process
    );
}
...
fn with_subbinary_with_bit_count_returns_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::binary_to_atom_2(subbinary_term, unicode_atom_term, &mut process),
        &mut process
    );
}
