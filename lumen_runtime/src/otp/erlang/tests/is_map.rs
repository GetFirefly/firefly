...
fn with_atom_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(atom_term, &mut process),
...
fn with_empty_list_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(empty_list_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_list_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(list_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_small_integer_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(small_integer_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_big_integer_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(big_integer_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_float_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(float_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_local_pid_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(local_pid_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_external_pid_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(external_pid_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_tuple_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(tuple_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_map_is_true() {
    ...
    assert_eq_in_process!(
        erlang::is_map(map_term, &mut process),
...
fn with_heap_binary_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(heap_binary_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
...
fn with_subbinary_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_map(subbinary_term, &mut process),
        false.into_process(&mut process),
        process
    );
}
