...
macro_rules! ok {
    ($value:expr) => {
        firefly_rt::function::ErlangResult::Ok($value)
    };
}

macro_rules! err {
    ($value:expr) => {
        firefly_rt::function::ErlangResult::Err($value)
    };
}

/// Constructs a new empty term of the given type and size on the current process heap
#[export_name = "__firefly_builtin_malloc"]
...
#[export_name = "__firefly_tuple_size"]
#[allow(improper_ctypes_definitions)]
...
#[export_name = "__firefly_make_tuple"]
...
#[export_name = "__firefly_set_element"]
#[allow(improper_ctypes_definitions)]
...
#[export_name = "__firefly_map_empty"]
...
#[export_name = "__firefly_map_put_mut"]
...
#[export_name = "__firefly_map_update"]
#[allow(improper_ctypes_definitions)]
...
#[export_name = "__firefly_map_update_mut"]
#[allow(improper_ctypes_definitions)]
...
#[export_name = "__firefly_map_fetch"]
#[allow(improper_ctypes_definitions)]
...
#[allow(improper_ctypes_definitions)]
#[export_name = "__firefly_bs_finish"]
...
#[allow(improper_ctypes_definitions)]
#[export_name = "__firefly_bs_match_start"]
...
#[export_name = "__firefly_bs_match_skip"]
...
#[export_name = "__firefly_bs_test_tail"]
