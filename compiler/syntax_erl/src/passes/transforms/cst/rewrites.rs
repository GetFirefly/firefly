    ...
    fn cexpr(
        ...
        match iexpr {
            ...
            IExpr::Case(mut case) => {
                ...
                let exported = intersection(case.new_vars(), exports.clone());
                let args = case
                    .args
                    .drain(..)
            ...
            IExpr::Try(mut texpr) => {
                ...
                let exported = intersection(
                    new_in_any(texpr.args.iter()),
                    used_in_any(texpr.body.iter()),
                );
