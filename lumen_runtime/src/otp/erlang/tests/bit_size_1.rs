...
fn with_atom_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size_1(atom_term, &mut process), &mut process);
}
...
fn with_local_reference_errors_badarg() {
    ...
    let process_rw_lock = environment::process(Arc::clone(&environment_rw_lock));
    let mut process = process_rw_lock.write().unwrap();
    let bitstring = Term::local_reference(&mut process);

    assert_bad_argument!(erlang::bit_size_1(bitstring, &mut process), &mut process);
}
...
fn with_empty_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::bit_size_1(Term::EMPTY_LIST, &mut process),
        &mut process
    );
}
...
fn with_list_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size_1(list_term, &mut process), &mut process);
}
...
fn with_small_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::bit_size_1(small_integer_term, &mut process),
        &mut process
    );
}
...
fn with_big_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::bit_size_1(big_integer_term, &mut process),
        &mut process
    );
}
...
fn with_float_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size_1(float_term, &mut process), &mut process);
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::bit_size_1(local_pid_term, &mut process),
        &mut process
    );
}
...
fn with_external_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::bit_size_1(external_pid_term, &mut process),
        &mut process
    );
}
...
fn with_tuple_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size_1(tuple_term, &mut process), &mut process);
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::bit_size_1(map_term, &mut process), &mut process);
}
...
fn with_heap_binary_is_eight_times_byte_count() {
    ...
    assert_eq_in_process!(
        erlang::bit_size_1(heap_binary_term, &mut process),
