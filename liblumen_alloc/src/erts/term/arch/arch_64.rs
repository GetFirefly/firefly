...
impl RawTerm {
    ...
    pub const HEADER_FLOAT: u64 = Encoding::TAG_FLOAT;
...
#[cfg(all(test, target_pointer_width = "64", not(target_arch = "x86_64")))]
mod tests {
    ...
    const MAX_IMMEDIATE_VALUE: u64 = Encoding64::MAX_IMMEDIATE_VALUE;
    const MAX_ATOM_ID: u64 = Encoding64::MAX_ATOM_ID;
    const MIN_SMALLINT_VALUE: i64 = Encoding64::MIN_SMALLINT_VALUE;
    const MAX_SMALLINT_VALUE: i64 = Encoding64::MAX_SMALLINT_VALUE;
