...
extern "C" {
    ...
    #[allow(unused)]
    pub fn MLIRGetCurrentBlockArgument(builder: ModuleBuilderRef, id: c_uint) -> ValueRef;

    pub fn MLIRGetBlockArgument(block: BlockRef, id: c_uint) -> ValueRef;
