...
fn with_local_reference_right_returns_false() {
    are_equal_after_conversion(|_, mut process| Term::local_reference(&mut process), false);
}
...
fn with_same_value_small_integer_right_returns_true() {
    are_equal_after_conversion(|_, mut process| 0.into_process(&mut process), true)
}

#[test]
fn with_different_small_integer_right_returns_false() {
    are_equal_after_conversion(|_, mut process| 1.into_process(&mut process), false)
}
...
fn with_same_value_float_right_returns_true() {
    are_equal_after_conversion(|_, mut process| 0.0.into_process(&mut process), true)
}

#[test]
fn with_different_value_float_right_returns_false() {
    are_equal_after_conversion(|_, mut process| 1.0.into_process(&mut process), false)
}
...
fn with_subbinary_right_returns_false() {
    are_equal_after_conversion(|_, mut process| bitstring!(1 :: 1, &mut process), false);
}
...
{
    super::are_equal_after_conversion(|mut process| 0.into_process(&mut process), right, expected);
}
