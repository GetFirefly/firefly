...
impl AtomTable {
    const DEFAULT_ATOMS: &'static [&'static str] = &[
        "false",
        "true",
    ];
    ...
    /// Used to initialize the atom table from an array of null-terminated strings with static lifetime,
    /// such as generated by codegen in order to initialize the atom table with constant atom values
    /// in the compiled program. It is expected that this will be called via `InitializeLumenAtomTable`
