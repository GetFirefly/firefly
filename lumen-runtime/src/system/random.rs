...
/// ## Algorithms
///
/// * 'exrop' - Xoroshiro116+, 58 bits precision and period of 2^116-1 (jump equivalent to 2^64 calls)
/// * 'exs1024s' - Xorshift1024*, 64 bits precision and period of 2^1024-1 (jump equivalent to 2^512)
...
/// The state can either be implicit or be an explicit argument and return value.
///
