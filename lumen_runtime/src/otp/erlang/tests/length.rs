...
fn with_atom_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::length(atom_term, &mut process), &mut process);
}
...
fn with_big_integer_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::length(big_integer_term, &mut process), &mut process);
}
...
fn with_float_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::length(float_term, &mut process), &mut process);
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::length(local_pid_term, &mut process), &mut process);
}
...
fn with_tuple_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::length(tuple_term, &mut process), &mut process);
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::length(map_term, &mut process), &mut process);
}
...
fn with_heap_binary_is_false() {
    ...
    assert_bad_argument!(erlang::length(heap_binary_term, &mut process), &mut process);
}
...
fn with_subbinary_is_false() {
    ...
    assert_bad_argument!(erlang::length(subbinary_term, &mut process), &mut process);
}
