...
extern "C" bool lumen_is_type(::lumen::Encoding *encoding, uint32_t type,
                              uint64_t value);
extern "C" uint64_t lumen_encode_immediate(::lumen::Encoding *encoding,
                                           uint32_t type, uint64_t value);
extern "C" uint64_t lumen_encode_header(::lumen::Encoding *encoding,
                                        uint32_t type, uint64_t arity);
