...
function(lumen_cc_library)
  cmake_parse_arguments(
    ...
    "NAME"
    "HDRS;TEXTUAL_HDRS;SRCS;COPTS;DEFINES;LINKOPTS;DEPS;DEPENDS;INCLUDES;LLVM_COMPONENTS;DISABLE_LLVM_LINK_LLVM_DYLIB"
    ${ARGN}
  )
  ...
  if ("${_RULE_LLVM_COMPONENTS}")
    if (LLVM_LINK_LLVM_DYLIB AND NOT _RULE_DISABLE_LLVM_LINK_LLVM_DYLIB)
      set(_LLVM_LIBS LLVM)
    else()
