...
fn with_atom_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(atom_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_local_reference_errors_badarg() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(tuple, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_empty_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(Term::EMPTY_LIST, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_list_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(list_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_big_integer_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(big_integer_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_float_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(float_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(local_pid_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_tuple_without_index_in_range_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(empty_tuple_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(map_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_heap_binary_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(heap_binary_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
...
fn with_subbinary_is_bad_argument() {
    ...
    assert_bad_argument!(
        erlang::delete_element_2(subbinary_term, 0.into_process(&mut process), &mut process),
        &mut process
    );
}
