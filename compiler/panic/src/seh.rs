...
// passing in, which in this case is a raw term (usize). Pretty easy to find! The
...
// support capturing exceptions with std::exception_ptr.
macro_rules! define_cleanup {
    ($abi:tt) => {
        ...
        unsafe extern $abi fn exception_copy(dest: *mut Exception,
                                             ...
                                             -> *mut Exception {
            let src = &*src;
            dest.write(Exception { data: src.data });
        }
    }
}
cfg_if::cfg_if! {
...
pub unsafe fn panic(data: *mut ErlangPanic) -> u32 {
    ...
    let mut exception = ManuallyDrop::new(Exception { data });
