...
fn with_atom_errors_badarg() {
    ...
    let list = Term::str_to_atom("atom", DoNotCare).unwrap();

    assert_badarg!(erlang::list_to_tuple_1(list, &mut process));
}
...
fn with_small_integer_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(small_integer_term, &mut process));
}
...
fn with_big_integer_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(big_integer_term, &mut process));
}
...
fn with_float_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(float_term, &mut process));
}
...
fn with_local_pid_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(local_pid_term, &mut process));
}
...
fn with_external_pid_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(external_pid_term, &mut process));
}
...
fn with_tuple_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(tuple_term, &mut process));
}
...
fn with_map_errors_badarg() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(map_term, &mut process));
}
...
fn with_heap_binary_is_false() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(heap_binary_term, &mut process));
}
...
fn with_subbinary_is_false() {
    ...
    assert_badarg!(erlang::list_to_tuple_1(subbinary_term, &mut process));
}
