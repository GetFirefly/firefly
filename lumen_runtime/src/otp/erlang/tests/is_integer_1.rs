...
fn with_atom_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(atom_term, &mut process),
        false_term,
        process
    );
}
...
fn with_local_reference_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(term, &mut process),
        false_term,
        process
    );
}
...
fn with_empty_list_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(empty_list_term, &mut process),
        false_term,
        process
    );
}
...
fn with_list_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(list_term, &mut process),
        false_term,
        process
    );
}
...
fn with_small_integer_is_true() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(zero_term, &mut process),
        true_term,
        process
    );
}
...
fn with_big_integer_is_true() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(big_integer_term, &mut process),
        true_term,
        process
    );
}
...
fn with_float_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(float_term, &mut process),
        false_term,
        process
    );
}
...
fn with_local_pid_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(local_pid_term, &mut process),
        false_term,
        process
    );
}
...
fn with_external_pid_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(external_pid_term, &mut process),
        false_term,
        process
    );
}
...
fn with_tuple_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(tuple_term, &mut process),
        false_term,
        process
    );
}
...
fn with_map_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(map_term, &mut process),
...
fn with_heap_binary_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(heap_binary_term, &mut process),
        false_term,
        process
    );
}
...
fn with_subbinary_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_integer_1(subbinary_term, &mut process),
        false_term,
        process
    );
}
