...
fn with_atom_is_true() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(atom_term, &mut process),
...
fn with_booleans_is_true() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(true_term, &mut process),
        true_term,
        process
    );
    assert_eq_in_process!(
        erlang::is_atom_1(false_term, &mut process),
        true_term,
        process
    );
}
...
fn with_nil_is_true() {
    ...
    let process_rw_lock = environment::process(Arc::clone(&environment_rw_lock));
    let mut process = process_rw_lock.write().unwrap();
    let nil_term = Term::str_to_atom("nil", DoNotCare, &mut process).unwrap();
    let true_term = true.into_process(&mut process);

    assert_eq_in_process!(
        erlang::is_atom_1(nil_term, &mut process),
        true_term,
        process
    );
}
...
fn with_local_reference_is_false() {
    ...
    assert_eq_in_process!(erlang::is_atom_1(term, &mut process), false_term, process);
}
...
fn with_empty_list_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(empty_list_term, &mut process),
        false_term,
        process
    );
}
...
fn with_list_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(list_term, &mut process),
        false_term,
        process
    );
}
...
fn with_small_integer_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(small_integer_term, &mut process),
        false_term,
        process
    );
}
...
fn with_big_integer_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(big_integer_term, &mut process),
        false_term,
        process
    );
}
...
fn with_float_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(float_term, &mut process),
        false_term,
        process
    );
}
...
fn with_local_pid_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(local_pid_term, &mut process),
        false_term,
        process
    );
}
...
fn with_external_pid_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(external_pid_term, &mut process),
        false_term,
        process
    );
}
...
fn with_tuple_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(tuple_term, &mut process),
        false_term,
        process
    );
}
...
fn with_map_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(map_term, &mut process),
...
fn with_heap_binary_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(heap_binary_term, &mut process),
        false_term,
        process
    );
}
...
fn with_subbinary_is_false() {
    ...
    assert_eq_in_process!(
        erlang::is_atom_1(subbinary_term, &mut process),
        false_term,
        process
    );
}
