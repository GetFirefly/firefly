...
fn with_atom_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(atom_term, &mut process), &mut process);
}
...
fn with_heap_binary_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(heap_binary_term, &mut process), &mut process);
}
...
fn with_subbinary_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(subbinary_term, &mut process), &mut process);
}
...
fn with_empty_list_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(Term::EMPTY_LIST, &mut process), &mut process);
}
...
fn with_list_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(list_term, &mut process), &mut process);
}
...
fn with_local_pid_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(local_pid_term, &mut process), &mut process);
}
...
fn with_external_pid_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(external_pid_term, &mut process), &mut process);
}
...
fn with_tuple_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(tuple_term, &mut process), &mut process);
}
...
fn with_map_is_bad_argument() {
    ...
    assert_bad_argument!(erlang::abs(map_term, &mut process), &mut process);
}
